...
def generate_launch_description():
   ...
   move_rviz = IncludeLaunchDescription(join(get_package_share_directory("maciv2_moveit"), "launch", "moveit_rviz.launch.py"))
   ...
   rviz_sim_time = ExecuteProcess(cmd=["ros2", "param", "set", "/move_rviz", "use_sim_time","True"])
   
   return LaunchDescription([gazebo_sim,robot,robot_state_publisher,start_controllers, move_group, move_rviz, bridge,mg_sim_time, rviz_sim_time])